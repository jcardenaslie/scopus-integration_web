...
<?php
    $url = 'http://api.elsevier.com/content/search/scopus?query=af-id(60001282)+and+au-id(18633451400)+or+au-id(8636909600)+or+au-id(23134786100)+or+au-id(54961345300)+or+au-id(55622910300)+or+au-id(56909888800)+or+au-id(12445523200)+or+au-id(55622555200)+or+au-id(12242564800)+or+au-id(7202770598)+or+au-id(24080990600)+or+au-id(26538028400)+or+au-id(56343347700)+or+au-id(24774150400)+or+au-id(12446764200)+or+au-id(36142374800)+or+au-id(57193050559)&count=10';
